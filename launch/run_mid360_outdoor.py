...
def generate_launch_description():
    config = os.path.join(get_package_share_directory('fastlio_localization'), 'config', 'ros2_mid360_outdoor.yaml')
    ...
    #     ]
    # )
    # return LaunchDescription([fastlio_localization, rviz2, static_tf])
